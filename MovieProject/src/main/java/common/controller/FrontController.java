...
@WebServlet (
	...
	urlPatterns = {"*.mp"},
	initParams = { 
		@WebInitParam(name = "propertyConfig", value = "/Users/gim-yeowon/Desktop/MovieProject/MovieProject/src/main/webapp/WEB-INF/Command.Properties", description = "*.mp 에 대한 클래스의 매핑파일") 
	}
)
