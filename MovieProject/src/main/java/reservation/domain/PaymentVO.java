...
public class PaymentVO {
	...
	// === Join Field === //
	private ShowtimeVO svo; // 상영영화VO
	private MemberVO mbvo; // 멤버VO
	private TicketVO tvo; //티켓VO
	...
	public ShowtimeVO getSvo() {
		return svo;
	}
	public void setSvo(ShowtimeVO svo) {
		this.svo = svo;
	}
	...
	public TicketVO getTvo() {
		return tvo;
	}
	public void setTvo(TicketVO tvo) {
		this.tvo = tvo;
	}
