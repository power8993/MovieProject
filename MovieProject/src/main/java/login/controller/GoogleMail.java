...
public class GoogleMail {
   ...
   public void send_certification_code(String recipient, String certification_code) throws Exception { 
      ...
      // 1. 정보를 담기 위한 객체
       ...
       prop.put("mail.smtp.user", "gimyeowon37@gmail.com"); 
       ...
       prop.put("mail.smtp.ssl.trust", "ywjjang.gmail.com");
    ...
    */ 
       ...
       // 제목 설정
       String subject = "HGV 회원님의 [비밀번호 찾기] 인증번호 발송완료";
       msg.setSubject(subject);
               
       // 보내는 사람의 메일주소
       String sender = "gimyeowon37@gmail.com";
       ...
       msg.setContent("발송된 인증코드 : <span style='font-size:14pt; color:red;'>"+certification_code+"<br>인증코드를 정확하게 입력해 주세요.</span>", "text/html;charset=UTF-8"); 
    ...
    */ 
       ...
       // 제목 설정
       String subject = name+"님의 주문이 성공했습니다.";
       msg.setSubject(subject);
       ...
       // 메시지 본문의 내용과 형식, 캐릭터 셋 설정
       msg.setContent("<div style='font-size:14pt; color:black;'>"+emailContents+"</div>", "text/html;charset=UTF-8");  
