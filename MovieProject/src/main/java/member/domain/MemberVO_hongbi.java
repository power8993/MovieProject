...
*/	
	...
	public int getReserved_cnt() {
		return reserved_cnt;
	}

	public void setReserved_cnt(int reserved_cnt) {
		this.reserved_cnt = reserved_cnt;
	}
	...
	public PointVO_hongbi getPtvo() {
		return ptvo;
	}

	public void setPtvo(PointVO_hongbi ptvo) {
		this.ptvo = ptvo;
	}

	public PaymentVO_hongbi getPvo() {
		return pvo;
	}

	public void setPvo(PaymentVO_hongbi pvo) {
		this.pvo = pvo;
	}
