...
public class UcfilterByGenre extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    try {
	        ...
	        if (genreCode != null && !genreCode.trim().isEmpty()) {
	            movies = mdao.ucgetMoviesByGenre(genreCode); // 특정 장르의 영화 가져오기(상영예)
	        } else {
	        ...
	        super.setViewPage("/WEB-INF/movie/upcomingMovies.jsp");
