	...
	<div class="my_main">
				...
				<li><a href="<%=ctxPath%>/mypage/mywatchedmovie.up">영화</a>
					<ul>
						<li><a href="<%=ctxPath%>/mypage/mywatchedmovie.up">내가 본
								영화</a></li>
						<li><a href="<%=ctxPath%>/mypage/myreview.up" class="active">내가
								쓴 평점</a></li>
		...
		<div class="mypage_main_content">
			<div class="my_movie_buttons">
				...
				</a> <a href="<%=ctxPath%>/mypage/myreview.up" class="button active">
					<i class="fa-solid fa-star"></i> 내가 쓴 평점
				</a> <a href="<%=ctxPath%>/mypage/mymovielike.up" class="button"> <i
