...
<head>
    ...
    <style>
        ...
        /* 장르 필터 폼 스타일 */
        form#getMoviesByGenre {
            display: flex;
            justify-content: flex-end;
            align-items: center;
        }

        form#getMoviesByGenre select {
            padding: 10px;
            margin-right: 10px;
        ...
        form#getMoviesByGenre button:hover {
...
<body>
    ...
    <div class="container mt-4">
        ...
        <form id="getMoviesByGenre" action="<%= ctxPath %>/movie/filterByGenre.mp" method="get">
    ...
    <script>
        function submitGenreForm() {
            document.getElementById('getMoviesByGenre').submit();
        }
