				...
				<div class="mycontainer2">
				    <h2>영화 등록</h2>
					  <form name="movie_register" method="post" action="<%= ctxPath%>/admin/movieRegister.up">
					      ...
					      <tbody>
					        ...
					        <tr>
					          <td>
					              ...
					              <textarea class="form-control" name="content" id="content" rows="4" placeholder="줄거리를 입력하세요."></textarea>
					            </div>
					          </td>
					        </tr>
					    ...
					    <button type="submit" class="btn btn-success" value="등록하기">영화등록하기</button>
