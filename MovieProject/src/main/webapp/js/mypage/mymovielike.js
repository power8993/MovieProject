	    ...
	    $.ajax({
	        ...
	        success: function(json) {
	            ...
	            if (start == "1" && json.length == 0) {
	                                ...
	                                <div class="movielikecss1">
	                                    <ul class="list-unstyled">
	                                        ...
	                                        <li class="text-center">
	                                            <a href="/MovieProject/movie/movieDetail.mp?seq_movie_no=${item.FK_SEQ_MOVIE_NO}" class="btn Detbto" role="button">예매하기</a>
	                                        </li>
	                                    </ul>
	                                </div>
	                            </div>
	                ...
	                // Update the totalmymovielike value
	                $("span#totalmymovielike").text(json.totalmymovielike);

	                // Check if totalmymovielike and mymovielikecount are equal
	                if (parseInt($("span#totalmymovielike").text()) === parseInt($("span#mymovielikecount").text())) {
	                    $("button#btnmymovielike").hide(); // Hide the button if counts match
	                }
	            }
	        },
